...
locals {
  function_name_get = "get-obituaries-30153653"
  function_name_create = "create-obituary-30153653"
...
resource "aws_dynamodb_table""obituaries-30153653"{
  name = "obituaries-30153653"
    ...
    Statement = [
      {
        ...
        Effect   = "Allow"
        Resource = "arn:aws:ssm:ca-central-1:690664345935:parameter/the-last-show/*"
      }
    ]
  })
}
